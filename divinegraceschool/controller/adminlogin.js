...
router.get("/",function(req,res){
	          	  ...
	          	  admin.findCount(tableobj,column,{user_role:4},function(err,teacher){
	          	   var teacher_count  = teacher[0].count;
	          		admin.findCount({tablename:'tbl_attendance'},column,{user_role:3,attendence_date:moment().format("YYYY-MM-DD")},function(err,attendence){
						...
						var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dashboard", success: req.flash('success'),error: req.flash('error'),parent_count:parent_count,student_count:student_count,teacher_count:teacher_count,attendence_count:attendence_count};
		...
		}else
		{
		      ...
		      setting = result[0];
		      console.log(setting);
		     var pagedata = {title : "Welcome Admin",active:'login', appName :res.locals.appName,pagename : "website/login", success: req.flash('success'),error : req.flash('error'),setting:setting};
		...
		if(result.length==1)
		{
			...
			if(data.user_password == p)
			{
				...
				if(data.user_role==1){
	            	...
	            	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "parent/dashboard", success: req.flash('success'),error: req.flash('error')};
	                res.render("admin_layout", pagedata);
	            

	            }else if(data.user_role==3){
	            	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "student/dashboard", success: req.flash('success'),error: req.flash('error')};
	                res.render("admin_layout", pagedata);
	            }else if(data.user_role==4){
                        

	            	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "teacher/dashboard", success: req.flash('success'),error: req.flash('error')};
	                res.render("admin_layout", pagedata);
	            }
			}
			else
			          		  	...
			          		  	req.session.phone = result1[0].phone;
			          		  	 ...
			          		  	 admin.findCount({tablename:'tbl_attendance'},column,{user_role:3,attendence_date:moment().format("YYYY-MM-DD")},function(err,attendence){
			          		 	    if(attendence==undefined )
										...
										var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dashboard",parent_count:parent_count,student_count:student_count,teacher_count:teacher_count,attendence_count:attendence_count};
									    res.render("admin_layout", pagedata);
							      });
							    });
							});
			          		...
			          		var teacher_count  = teacher[0].count;
			          		  ...
			          		  //console.log("attendence[0].count",attendence[0].count)
			          		    if(attendence==undefined)
			          		      ...
			          		      var attendence_count	  = attendence[0].count;
							      var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dashboard", message : req.flash('msg'),parent_count:parent_count,student_count:student_count,teacher_count:teacher_count,attendence_count:attendence_count};
							    res.render("admin_layout", pagedata);
							  });
							});
						});
                 ...
                 admin.findWhere(table,{name:req.body.student_name,admission_number:req.body.admission_number,email:req.body.student_email,phone:req.body.student_phone},function(err, result){
                   ...
                   var student_data = {
		 			...
		 			if(typeof file=="undefined"){
					  	...
					  	var filepath = path.join('vedahighschool/',"public/images/"+newname);
...
router.get("/Shiftsection", function(req, res){ 
    ...
    if(req.session.user_role==1 && req.session.sitename==res.locals.appName)
    {
        admin.findAll({table:'tbl_class'},function(err, result){
             var class_list      = result;
             var pagedata      = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/student_shift",success: req.flash('success'),error: req.flash('error'),class_list:class_list};
             res.render("admin_layout", pagedata); 
        });
   ...
   if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
   	...
   	var table  = 'tbl_class';
		...
		admin.findAll({table:table},function(err, result){
		  ...
		  var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/promotion", success: req.flash('success'),error: req.flash('error'),class_list:class_list,session_year:session_year};
	    res.render("admin_layout", pagedata);
		});
					...
					admin.findAll({table:'tbl_transport'},function(err,result){
						 ...
						 transport_list  = result;
							...
							admin.findAll({table:'tbl_dormitory'},function(err,result){
								 ...
								 var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/Registration", success: req.flash('success'),error: req.flash('error'),class_list:class_list,section_list:"",transport_list :transport_list,dormitory_list:dormitory_list,admission_number:admission_number,studentdata:""};
  ...
  if(req.session.user_role==1 && req.session.sitename==res.locals.appName)
	{
	  ...
	  else
	  {
        findObj={class_id:req.query.id}
  	    ...
  	    admin.findAll({table:'tbl_class'},function(err, result){
          var class_list      = result;
          var pagedata      = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/student_bonafide",  success: req.flash('success'),error: req.flash('error'),class_list:class_list};
          res.render("admin_layout", pagedata);
  	    });
	  } 	
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	 var table = 'tbl_enroll'
			 admin.findAll({table:table},function(err, result){
			 	...
			 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport_list", message : req.flash('msg'),transport_list :transport_list};
	                 res.render("admin_layout", pagedata);
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName)
	{
  	  if(req.query.id)
	  {
         ...
         admin.findWhere(tableobj,findObj,function(err,result){
          ...
          var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classes", success: req.flash('success'),error: req.flash('error'),classdata:$data[0],class_list:''};   	
          res.render("admin_layout", pagedata)
         });
	  }
	  else
	  {
		...
		admin.findAll({table:table},function(err, result){
			var class_list = result;
			var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classes", success: req.flash('success'),error: req.flash('error'),class_list :class_list,classdata:''};
		    res.render("admin_layout", pagedata);
         ...
         {	
           var table = 'tbl_class'
				 admin.findAll({table:table},function(err, result){
				 	...
				 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/class_list", success : req.flash('success'), error : req.flash('error'),class_list :class_list};
		                 res.render("admin_layout", pagedata);
				 });   
		  }
        });
	  ...
	  else
	  {
	  	if(name==""||numeric_value=="")
	  	{
		   ...
		   admin.findAll({table:table},function(err, result){
				...
				var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classes", success : req.flash('success'), error : req.flash('error'),classdata:"",class_list :class_list};
			 	res.render("admin_layout", pagedata);
			});
	  	}
	  	else
	  	{
            ...
            $data={class_name:name};
		  	admin.findWhere({tablename:'tbl_class'},{class_name : name},function(err, result){
	           ...
	           var  pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classes", success : req.flash('success'), error : req.flash('error'),classdata:$data,class_list:''};   	
	                 res.render("admin_layout", pagedata);
			...
			admin.findAll({table:table},function(err, result){
                ...
                if(result1)
                 {
                    ...
                    //console.log('ddd') ;
                    //console.log(data[0]);
				    var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/section", success : req.flash('success'), error : req.flash('error'),class_list:class_list,section_data:data[0],section_list:''};
				    res.render("admin_layout", pagedata);
                 }
              ...
              else
              {
			    ...
			    admin.findAllSection({table:table},function(err, result){
					 	...
					 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/section",success : req.flash('success'), error : req.flash('error'),section_list :section_list,class_list:class_list,section_data:''};
			                 res.render("admin_layout", pagedata);
			  	 ...
			  	 if(result.length>0)
			  	 {
		            ...
		            section_data={
		             ...
		             var table = 'tbl_section'
					    admin.findAllSection({table:table},function(err, result){
							 	var section_list = result;
							 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/section_list",success : req.flash('success'), error : req.flash('error'),section_list :section_list};
					                 res.render("admin_layout", pagedata);
	    ...
	    if(req.query.id)
	     {
           ...
           if(result)
           {
              ...
              console.log($data[0]);
              var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport", success: req.flash('success'),error: req.flash('error'),transportdata:$data[0],transport_list:''};
		      res.render("admin_layout", pagedata);
           }
           });
	     }
	     else
	     {
	     	...
	     	admin.findAll({table:table},function(err, result){
			 	var transport_list = result;
			 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport",success: req.flash('success'),error: req.flash('error'),transport_list :transport_list,transportdata:''};
	                 res.render("admin_layout", pagedata);
          	...
          	admin.findWhere({tablename:'tbl_transport'},{ route_name : route_name,number_of_vehicle:number_of_vehicle},function(err, result){
	           ...
	           var table = 'tbl_transport'
	     	   admin.findAll({table:table},function(err, result){
	             ...
	             var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport",success: req.flash('success'),error: req.flash('error'),transport_list :transport_list,transportdata:transportdata};
	             res.render("admin_layout", pagedata);
...
router.get("/transportList", function(req, res){
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	 var table = 'tbl_transport'
			 admin.findAll({table:table},function(err, result){
			 	var transport_list = result;
			 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport_list",success: req.flash('success'),error: req.flash('error'),transport_list :transport_list};
	                 res.render("admin_layout", pagedata);
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
		...
		if(req.query.id)
	    {
           ...
           if(result)
           {
              var $data =JSON.parse(JSON.stringify(result)); 
              console.log($data[0]);
              var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dormitory", message : req.flash('msg'),dormitoryData:$data[0],dormitory_list:''};
		      res.render("admin_layout", pagedata);
           }
           });
	    }
	    	...
	    	var table = 'tbl_dormitory'
			 admin.findAll({table:table},function(err, result){
			 	...
			 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dormitory", message : req.flash('msg'),dormitoryData:'',dormitory_list :dormitory_list};
	                 res.render("admin_layout", pagedata);
			...
			admin.insert_dormitory({ name : name,number_of_room:number_of_room,description :description,created_at:created_at}, function(err, result){
				...
				if(result)
				{
					//var data = JSON.parse(JSON.stringify(result[0]));
					 ...
					 admin.findAll({table:table},function(err, result){
					 	var dormitory_list = result;
					 	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/dormitory_list", message : req.flash('msg'),dormitory_list :dormitory_list};
			                 res.render("admin_layout", pagedata);
						...
						//console.log('^^^^^^^^^^^^^^^^^^',student_list)
	                      //res.send({student_list:student_list});
	                       var student_list = result;
						 	...
						 	//console.log('req.query',req.query);
				            	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/student_list", message : req.flash('msg'),student_list :student_list,class_list:class_list,section_list:section_list,studentdata:req.query};
				                res.render("admin_layout", pagedata);
		 ...
		 else
		 {
	        ...
	        admin.findAll({table:'tbl_class'},function(err, result){
			  ...
			  admin.findAll({table:'tbl_section'},function(err, result){
					     ...
					     n++;
	                       ...
	                       var student_list = result;
				            ...
				            if(req.query.class_id &&  req.query.section_id )
				            {
				              ...
				              admin.findWhere({tablename:'tbl_section'},{class_id:class_id},function(err, result){	
				               var section_list 	 = result; 
				               var pagedata 	 = {title : "Welcome Admin", pagename : "admin/student_list", message : req.flash('msg'),student_list :student_list,class_list:class_list,section_list:section_list,studentdata:req.query};
				                res.render("admin_layout", pagedata);
	              ...
	              */ 
	              var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/student_list", message : req.flash('msg'),student_list :"",class_list:class_list,section_list:section_list,studentdata:""};
				   res.render("admin_layout", pagedata);
				});
			  });	 
        }
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    //console.log(table);
			 admin.findWhere(table,{user_role:'4'},function(err, result){
			 	...
			 	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/teacher_list", message : req.flash('msg'),teacher_list :teacher_list};
	            res.render("admin_layout", pagedata);
			});
	}else{
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    //console.log(table);
			 ...
			 /* 	 
			   ...
			   */
			   var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/teacheredit", message : req.flash('msg'),teacherdata :JSON.parse(JSON.stringify(teacherdata[0]))};
	            res.render("admin_layout", pagedata);
		  });	   
	}else{
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    console.log(table);
			 admin.findWhere(table,{user_role:'5'},function(err, result){
			 	...
			 	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/accountant_list", message : req.flash('msg'),accountant_list :accountant_list};
	            res.render("admin_layout", pagedata);
			});
	}else{
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    var table = {tablename:'tbl_registration'};
			 admin.findWhere(table,{user_role:'5',registration_id:registration_id},function(err, result){
			   ...
			   var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/accountantedit", message : req.flash('msg'),accountantdata :JSON.parse(JSON.stringify(accountantdata[0]))};
	            res.render("admin_layout", pagedata);
		  });	   
	}else{
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    //console.log(table);
			 admin.findWhere(table,{user_role:'6'},function(err, result){
			 	...
			 	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/librarian_list", message : req.flash('msg'),librarian_list :librarian_list};
	            res.render("admin_layout", pagedata);
			});
	}else{
	      website.findbyColumn({table:'tbl_frontend_settings',column:'header_logo'},function(err,result){
...
router.get("/librarianDetail", function(req, res){
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	    ...
	    //console.log(table);
             ...
             */
			   var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/librarianedit", message : req.flash('msg'),librariandata :JSON.parse(JSON.stringify(librariandata[0]))};
	            res.render("admin_layout", pagedata);
		  });	   
	}else{
	      website.findbyColumn({table:'tbl_frontend_settings',column:'header_logo'},function(err,result){
...
router.get("/classRoutine", function(req, res){
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
		...
		admin.findAll({table:table},function(err, result){
		    var class_list 	 = result;
			var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classRoutine", success: req.flash('success'),error: req.flash('error'),class_list:class_list};
			res.render("admin_layout", pagedata);
		});
    }else{
	       website.findbyColumn({table:'tbl_frontend_settings',column:'header_logo'},function(err,result){
  	...
  	async.forEachOf(subject_id, function (item,index, done) {
        ...
        if(file['subject_file_'+subject_id[index]])
        {
          file1= file['subject_file_'+subject_id[index]];
			...
			var filepath = path.join('vedahighschool/',"public/homework_image/"+newname);
           ...
           if(object.hasOwnProperty("checktosend"))
           {
	  		...
	  		admin.findAll({table:table},function(err, result){
			   ...
			   admin.findhomework({table:table},function(err, result){
				...
				var homework_list 	 = result;
				var pagedata = {title : "Welcome Admin", moment:moment,appName :res.locals.appName, pagename : "admin/homework", success: req.flash('success'),error: req.flash('error'),class_list:class_list,homework_list:homework_list};
				res.render("admin_layout", pagedata);
			   });
			});
  	    });
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
		...
		admin.findAll({table:table},function(err, result){
		    ...
		    async.each(teacher_list, function (item, done) {
			    ...
			    var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/attendence", success : req.flash('success'),error : req.flash('error'),class_list:class_list,teacher_list:teacher_list};
					    res.render("admin_layout", pagedata);
...
router.get("/studentattendencereport",function(req,res){
   	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
        ...
        admin.findAll({table:'tbl_class'},function(err, result){
		    var class_list 	 = result;
			 	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/studentattendencereport", message : req.flash('msg'),student_information :"",class_list:class_list,month:month,year:year,nextyear:nextyear};
	            res.render("admin_layout", pagedata);
		});
   ...
   if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	   ...
	   // var table = {tbl_attendance:'tbl_attendance',tbl_registration:'tbl_registration'};
	    //admin.getteacherlist_by_attendence(table,{session_year:session_year,month:month,year:year,user_role:4},function(err, result){
	    	admin.getAllStudentAttendence(table,{class_id:class_id,section_id:section_id,session_year:session_year,month:month,year:year,user_role:3},function(err, result){
		   	console.log(result);
		   	var student_list = result;
...
router.get("/teacherattendencereport",function(req,res){
   	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
        ...
        admin.findAll({table:'tbl_class'},function(err, result){
		    var class_list 	 = result;
			 	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/teacherattendencereport", message : req.flash('msg'),student_information :"",class_list:class_list,month:month,year:year,nextyear:nextyear};
	            res.render("admin_layout", pagedata);
		});
	            ...
	            if(result){
	               var $data =JSON.parse(JSON.stringify(result[0])); 
					...
					admin.findAll({table:table},function(err, result){
					  var class_list 	 = result;
					  console.log($data);
		              var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/academic_syllabus", success: req.flash('success'),error: req.flash('error'),academic_syllabusData:$data,academic_syllabus:'',class_list:class_list};
				      res.render("admin_layout", pagedata);
				    });
	            }
           	});
	...
	var created_date 		= moment().format('YYYY-MM-DD:hh:mm:ss');
     ...
     else
     {
    	if(typeof file=="undefined"){
		  	...
		  	var newname = changename(file.name);
		  	var filepath = path.join('vedahighschool/',"public/syllabus/"+newname);
		  		file.mv(filepath, function(err){
					if(err){
						console.log(err);
						return;
  ...
  if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	...
	var created_date = moment().format('YYYY-MM-DD:hh:mm:ss');
  	...
  	if(typeof file=="undefined"){
	  	...
	  	var newname = changename(file.name);
	  	var filepath = path.join('vedahighschool/',"public/study_material/"+newname);
         ...
         if( teacher_id!='' )
         {
          ...
          function(){
				...
				admin.findAll({table:table},function(err, result){
					...
					var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classRoutine", success: req.flash('success'),error: req.flash('error'),class_list:class_list,rejected_list:rejecteddata};
					res.render("admin_layout", pagedata);
...
router.get("/classroutineList", function(req, res){
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
						...
						var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classRoutineList", message : req.flash('msg'),class_list:class_list,class_routine:''};
		...
		var section_id = req.body.section_id;
			...
			//console.log(arr3);
				...
				async.each(day, function (item, done) {
						...
						admin.findAll({table:table},function(err, result){
						    var class_list 	 = result;
						var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/classRoutineList", message : req.flash('msg'),class_routine:class_routine,class_list:class_list};
						res.render("admin_layout", pagedata);
						});
  ...
  if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
	...
	var dates 				= moment().format('YYYY-MM-DD:hh:mm:ss');
  	...
  	var data = [];
 		file1= file;
  		var newname = changename(file.name);
		var filepath = path.join('vedahighschool/',"public/question_paper/"+newname);
   ...
   if(req.session.user_role==1 && req.session.sitename==res.locals.appName )
    {
      ...
      {
        where= {condition:'tbl_registration.dormitory_id=0 ',hosterlsclass:'class_id='+req.body.visiableclass,session_year:session_year}
      }
      ...
      {
      	var where= {condition:'staff_category="T" AND user_role:4',session_year:session_year}
      }
      else if(req.body.class_id=="Nstff")
      {
      	var where= {condition:'staff_category="N" AND user_role=4',session_year:session_year}
      }
      else if(req.body.class_id=="ALLT")
      {
        var where= {condition:'user_role=4',session_year:session_year}
      }
      else if(req.body.class_id=="ALLP")
      {
        var where= {condition:'user_role=2',session_year:session_year}
      }
      else 
      {
...
router.post("/bulkimport",function(req,res){
  		...
  		var newname = changename(file.name);
		var filepath = path.join('divinegraceschool/',"public/bulkimport/"+newname);
  	...
  	if(type =='about_us'){
		...
		var footer_logo = req.files.footer_logo;
	  	...
	  	if(typeof footer_logo=="undefined"){
		  	...
		  	var filepath = path.join('vedahighschool/',"public/images/"+ff);
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
		...
		if(req.query.id){
	        ...
	        admin.findWhere(tableobj,findObj,function(err,result){
	           ...
	           admin.findAll({table:table},function(err, result){
				    var class_list 	 = result;
		           	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/accounting_fee_type", message : req.flash('msg'),fee_data:$data[0],class_list:class_list,fees_type:''};   	
		           	res.render("admin_layout", pagedata);
	        	});
	        });
	  	}else{
	...
	if(req.session.user_role==1 && req.session.sitename==res.locals.appName){
		...
		if(req.query.id){
	        ...
	        admin.findWhere(tableobj,findObj,function(err,result){
	           ...
	           admin.findAll({table:table},function(err, result){
				    var class_list 	 = result;
		           	var pagedata 	 = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/accounting_fee_term", message : req.flash('msg'),fee_data:$data[0],class_list:class_list,fees_term:''};   	
		           	res.render("admin_layout", pagedata);
	        	});
	        });
	  	}else{
	           ...
	           var term_table = {tablename:'tbl_fees_term'}
	            admin.findTermById(term_table,{class_id:class_id},function(err, result){
	            	...
	            	admin.findTypeById(type_table,{class_id:class_id},function(err, result){
			            ...
			            admin.findAll({table:table},function(err, result){
						    var class_list 	 = result;
				           	var pagedata 	 = {title : "Welcome Admin", appName :res.locals.appName,pagename : "admin/fees_structure", message : req.flash('msg'),fee_data:$data[0],class_list:class_list,fees_structure:'',fees_term:fees_term,fees_type:fees_type};   	
				           	res.render("admin_layout", pagedata);
			        	});
		      	    });
	       		});
            ...
            if(req.query.id){
                admin.findWhere(tableobj,findObj,function(err,result1){
	                if(result1){
	                    ...
	                    console.log('ddd') ;
	                    console.log(data[0]);
					    var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/noticeBoard", message : req.flash('msg'),noticeBoard : data[0]};
					    res.render("admin_layout", pagedata);
	                }

 			    });
            }else{
            	var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/noticeBoard", message : req.flash('msg'),noticeBoard :''};
					    res.render("admin_layout", pagedata);
            }
	}else{
	      website.findbyColumn({table:'tbl_frontend_settings',column:'header_logo'},function(err,result){
            ...
            if(req.query.id){
                admin.findWhere(tableobj,findObj,function(err,result1){
	                if(result1){
	                    ...
	                    console.log('ddd') ;
	                    console.log(data[0]);
					    var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/Events", message : req.flash('msg'),Events : data[0]};
					    res.render("admin_layout", pagedata);
	                }
           ...
           if(result)
	           {
	              ...
	              admin.findWhere(tableobj1,findObj1,function(err,result1){
		              ...
		              var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/payment_edit", success: req.flash('success'),error: req.flash('error'),paymentData:$data[0],total_fees:total_fees};
				      res.render("admin_layout", pagedata);
			      });
	           }
           });
           ...
           if(result)
	           {
	              ...
	              admin.findStudentTransportFees(table_enroll,{registration_id:registration_id},function(err,result1){
		              ...
		              var pagedata = {title : "Welcome Admin",appName :res.locals.appName, pagename : "admin/transport_payment_edit", success: req.flash('success'),error: req.flash('error'),paymentData:$data[0],total_fees:total_fees};
				      res.render("admin_layout", pagedata);
			      });
	           }
           });
