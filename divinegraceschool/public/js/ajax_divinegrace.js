...
$('#class_id').on('change',function(){
    ...
    if(class_id=="")
    {
	 ...
	 $.ajax({
        url: "/divinegraceschool/admin/getSection",
        method: "GET",
        dataType: "json",
        data: {
            class_id: class_id
...
$('#homework_section_id').on('change',function(){
    ...
    //alert(class_id);
     ...
     $.ajax({
        url: "/divinegraceschool/admin/getSubject",
        method: "GET",
        dataType: "json",
        data: {
            class_id: class_id,
...
function delete_record(id, tr_id,tablename,columname) {        
     swal({            
        ...
        $.ajax({                
            url: "/divinegraceschool/admin/delete",                
            data: {                    
                id: id, 
...
function delete_slider_record(id, tr_id,tablename,columname) {        
 ...
 function get_all_data(id){
    var class_id = id;
    $.ajax({
        url: "/divinegraceschool/admin/getAllData",
        method: "GET",
        dataType: "json",
        data: {
            class_id: class_id
...
function get_all_exam_data(id){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getAllExamData",
        method: "GET",
        dataType: "json",
        data: {
            class_id   : class_id,
 ...
 function get_all_exam_name(id){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getAllExamName",
        method: "GET",
        dataType: "json",
        data: {
            class_id   : class_id,
 ...
 function get_scheduled_exam()
 {
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getSecheduledExamName",
        method: "GET",
        dataType: "json",
        data: {
            class_id   : class_id,
...
function get_marks_exam_list()
{
       ...
       var section_id    = $('#section_id').val();
        ...
        $.ajax({
            url: "/divinegraceschool/admin/getMarksExamNameList",
            method: "GET",
            dataType: "json",
            data: {
                class_id   : class_id,
...
function get_tabulate_exam_marks()
{
     ...
     $('#tabulation_table thead').html('');
        ...
        $.ajax({
            url: "/divinegraceschool/admin/getTabulateMarksList",
            method: "GET",
            dataType: "json",
            data: {
                class_id   : class_id,
...
function getsubteacher(day){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getsubjTeach",
        method: "GET",
        dataType: "json",
        data: {
            class_id: class_id,
...
function getStudentAttendence(attendence_date){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getStudentAttendence",
        method: "GET",
        dataType: "json",
        data: {
            class_id        : class_id,
...
function getTeacherAttendence(attendence_date){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getTeacherAttendence",
        method: "GET",
        dataType: "json",
        cache:true,
        data: {
...
function get_student_detail()
{
    ...
    if(exam_id=="")
    {
     ...
     $.ajax({
        url: "/divinegraceschool/admin/getStudentAllDetail",
        method: "GET",
        dataType: "json",
        data: {
            class_id        : class_id,
...
function get_studentlist()
{
     ...
     if(sectionid=="")
     {
        ...
        $.ajax({
            url: "/divinegraceschool/admin/classsection_studentList",
            method: "GET",
            dataType: "json",
            data: {
                class_id: classid,
              ...
              $('.studentlistTable tbody').html('');
                ...
                if(students.length>0){ 
                  ...
                  for (var i = 0; i < students.length; i++) {
                       ...
                       tablerow+='<td><a href="/divinegraceschool/admin/Registration?registration_id='+students[i].registration_id+'"><button type="button" class="btn btn-dark btn-fw"><i class="mdi mdi-cloud-download"></i>Edit</button>';
...
function get_subjectlist()
{
     ...
     $.ajax({
        url: "/divinegraceschool/admin/classsection_subjectList",
        method: "GET",
        dataType: "json",
        data: {
            class_id: classid,
        ...
        success: function(response) {
            ...
            if(subjects.length>0){ 
              for (var i = 0; i < subjects.length; i++) {
                   ...
                   tablerow+='<td><a href="/divinegraceschool/admin/Subject?subject_id='+subjects[i].subject_id+'"><button type="button" class="btn btn-dark btn-fw"><i class="mdi mdi-cloud-download"></i>Edit</button>';
...
function get_teacherlist(classid)
{
     ...
     $.ajax({
        url: "/divinegraceschool/admin/class_teacherList",
        method: "GET",
        dataType: "json",
        data: {
            class_id: classid,
        ...
        success: function(response) {
            ...
            if(teachers.length>0){ 
              for (var i = 0; i < teachers.length; i++) {
                   ...
                   tablerow+='<td><a href="/divinegraceschool/admin/AssignTeacher?id='+teachers[i].id+'"><button type="button" class="btn btn-dark btn-fw"><i class="mdi mdi-cloud-download"></i>Edit</button>';
...
function getStudentTobonafide(attendence_date){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/All_studentList",
        method: "GET",
        dataType: "json",
        data: {
            class_id        : class_id,
...
function getStudentforpromotion(){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/classsection_promotion",
        method: "GET",
        dataType: "json",
        data: {
            class_id        : class_id,
              ...
              for (var i = 0; i < student_list.length; i++) {
                 ...
                 Adate='';Bdate='';
                   if(student_list[i].bonafide_date)
                   {
                    ...
                    //link="http://divinegraceschool.com/images/panchavati-logo.png";
                    var DOB='';
...
function get_student_by_class(section_id){
    ...
    $.ajax({
        url: "/divinegraceschool/admin/get_student_by_class_id",
        method: "GET",
        dataType: "json",
        data: {
            class_id        : class_id,
...
function printDiv(elem)
{
   ...
   // mywindow.document.write('<img src="http://divinegraceschool.com/images/panchavati-logo.png" alt="gffffff">');
...
function Formative1(student_id,class_id,section_id)
{
    ...
    $.ajax({
        url: "/divinegraceschool/admin/getMarsksheet",
            method: "GET",
            dataType: "json",
            data: {
                class_id   : class_id,
    ...
    function get_fees_tt(class_id){
        ...
        $.ajax({
            url: "/divinegraceschool/admin/get_fess_tt",
            method: "GET",
            dataType: "json",
            data: {
                class_id        : class_id,
    ...
    function ajax_get_student_fees(){        
        ...
        $.ajax({
                url: "/divinegraceschool/admin/ajax_get_student_fees",
                method: "GET",
                dataType: "json",
                data: {
                    class_id        : class_id,
    ...
    function paid_fees(){
           var favorite = [];
            ...
            $.ajax({
               url: '/divinegraceschool/admin/get_payment_data',
               type: 'GET',
               data : {
                      fees:favorite,
                      user_id: user_id
    ...
    function pay_fees(){
         ...
         console.log(user_id);
          ...
          $.ajax({
                 url: '/divinegraceschool/admin/pay_fees' ,
                 type: 'GET',
                 data : {
                        fee_id:fee_id,
                        amount:amount,
    ...
    function pay_transport_fees(){
         if($("input[name='transport_id']:checked").length>0){
          var user_id = $('#student_id').val();
            $.ajax({
               url: '/divinegraceschool/admin/ajax_get_transport_fees' ,
               type: 'GET',
               data : {
      ...
      function transport_discount_validation($discount){
        ...
        function insert_transport_fees(){
         ...
         $.ajax({
                 url: '/divinegraceschool/admin/insert_transport_payment',
                 type: 'GET',
                 data : {
                        amount:amount,
                        discount:discount,
    ...
    function ajax_get_payment_receipt_data(){
        ...
        $.ajax({
                 url: '/divinegraceschool/admin/ajax_get_payment_receipt_data',
                 type: 'GET',
                 data : {
                        class_id     :class_id,
    ...
    function ajax_get_payment_receipt_data_by_date(){
        ...
        $.ajax({
                 url: '/divinegraceschool/admin/ajax_get_payment_receipt_data_by_date',
                 type: 'GET',
                 data : {
                        from     :from,
                        to       :to,
    ...
    function get_receipt_detail(receipt_number){
        ...
        var student_id      = $('#student_id').val();
        $.ajax({
                 url: '/divinegraceschool/admin/get_receipt_detail',
                 type: 'GET',
                 data : {
    ...
    function get_transport_receipt_detail(receipt_number){
        ...
        var student_id      = $('#student_id').val();
        $.ajax({
                 url: '/divinegraceschool/admin/get_transport_detail',
                 type: 'GET',
                 data : {
                        receipt_number:receipt_number,
                        student_id:student_id
...
function get_studentlist_attendance()
{
     ...
     $.ajax({
        url: "/divinegraceschool/admin/getAdminStudentAttendanceReport",
        method: "GET",
        dataType: "json",
        data: {
            class_id: classid,
...
function get_admin_student_attendance(class_id,section_id,registration_id)
{
    ...
    var year = $("#currentyear").val();
      $.ajax({
            url: "/divinegraceschool/admin/get_admin_student_attendance",
            method: "GET",
            dataType: "json",
            data: {
                class_id   : class_id,
...
function get_teacherlist_attendance()
{
     ...
     $.ajax({
        url: "/divinegraceschool/admin/getAdminTeacherAttendanceReport",
        method: "GET",
        dataType: "json",
        data: {
            class_id: classid,
